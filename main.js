...
// Change colours on zoom
map.on('zoom', function() {
    // started out with map.setStyle() but it rendered very slowly; setPaintProperty() is faster
    map.setPaintProperty("water", "fill-color", getRandomColor());
    map.setPaintProperty("gebouwen", "fill-color", getRandomColor());
//    map.setPaintProperty("terein_agrarisch", "fill-color", getRandomColor());
});
